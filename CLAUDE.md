...
- `skills/` — 64 composable CTI skills flat at the repo root per Agent Skills spec. Each is a directory with a `SKILL.md`. Canonical user-invokable interface. Works in any Agent-Skills-compatible IDE.
